...
# Каталог 1:1 с tg-ботом (единая номенклатура — обе ветки пишут в одну CRM)
PRODUCTS = {
    "Щебень 5-20 (дробл.90%+)": 345,
    "Щебень 5-20":           303,
    "Щебень 20-40":          303,
    "Щебень 40-70":          626,
    "Гравий 5-20":           166,
    "Гравий 20-70":          251,
    "Песок мытый (отсев 0-5)": 638,
    "Песок средний":         566,
    "Песок мелкий":          233,
    "Булыга 60+":            313,
    "ОГПС 0-20 (м/з)":      244,
    "ОГПС 0-20 (к/з)":      375,
    "ГПС 0-70":             160,
    "ГПС 0-70 (Земснаряд)": 212,
    "ГПС 0-70 (Верхний слой)": 80,
    "ЩГПС (С4-С7)":         None,
}

DENSITY = {
    "Щебень 5-20 (дробл.90%+)": 1.45,
    "Щебень 5-20":           1.45,
    "Щебень 20-40":          1.45,
    "Щебень 40-70":          1.45,
    "Гравий 5-20":           1.45,
    "Гравий 20-70":          1.45,
    "Песок мытый (отсев 0-5)": 1.27,
    "Песок средний":         1.50,
    "Песок мелкий":          1.50,
    "Булыга 60+":            1.60,
    "ОГПС 0-20 (м/з)":      1.60,
    "ОГПС 0-20 (к/з)":      1.60,
    "ГПС 0-70":             1.77,
    "ГПС 0-70 (Земснаряд)": 1.77,
    "ГПС 0-70 (Верхний слой)": 1.77,
    "ЩГПС (С4-С7)":         1.60,
}
DEFAULT_DENSITY = 1.5
...
PRODUCT_GENITIVE = {
    "Щебень 5-20 (дробл.90%+)": "щебня 5-20 (дробл.90%+)",
    "Щебень 5-20": "щебня 5-20",
    "Щебень 20-40": "щебня 20-40",
    "Щебень 40-70": "щебня 40-70",
    "Гравий 5-20": "гравия 5-20",
    "Гравий 20-70": "гравия 20-70",
    "Песок мытый (отсев 0-5)": "песка мытого (отсев 0-5)",
    "Песок средний": "песка среднего",
    "Песок мелкий": "песка мелкого",
    "Булыга 60+": "булыги 60+",
    "ОГПС 0-20 (м/з)": "ОГПС 0-20 (м/з)",
    "ОГПС 0-20 (к/з)": "ОГПС 0-20 (к/з)",
    "ГПС 0-70": "ГПС 0-70",
    "ГПС 0-70 (Земснаряд)": "ГПС 0-70 (Земснаряд)",
    "ГПС 0-70 (Верхний слой)": "ГПС 0-70 (Верхний слой)",
    "ЩГПС (С4-С7)": "ЩГПС (С4-С7)",
}
...
def parse_order_regex(text: str) -> OrderParsed:
    ...
    if not result.product:
        patterns = [
            (r'дробл|90\s*%', "Щебень 5-20 (дробл.90%+)"),
            ...
            (r'булыг', "Булыга 60+"),
            (r'\bотсев\b|песок.*?мыт|мыт.*?песок', "Песок мытый (отсев 0-5)"),
            (r'гравий.*?20-70|20-70.*?гравий', "Гравий 20-70"),
            (r'гравий', "Гравий 5-20"),
            (r'огпс.*?к[\\/]?з|к[\\/]?з.*?огпс', "ОГПС 0-20 (к/з)"),
            (r'огпс.*?м[\\/]?з|м[\\/]?з.*?огпс|\bогпс\b', "ОГПС 0-20 (м/з)"),
            (r'щгпс|с4-с7|\bс4\b|\bс7\b', "ЩГПС (С4-С7)"),
            (r'земснаряд', "ГПС 0-70 (Земснаряд)"),
            (r'верхн.*?слой|слой.*?верхн', "ГПС 0-70 (Верхний слой)"),
            (r'гпс.*?плох|плох.*?гпс', "ГПС 0-70 (Верхний слой)"),
            (r'гпс.*?хор|хор.*?гпс', "ГПС 0-70"),
            (r'\bгпс\b', "ГПС 0-70"),
            (r'песок.*?мелк|мелк.*?песок', "Песок мелкий"),
            (r'песок.*?сред|сред.*?песок|песок.*?круп|круп.*?песок', "Песок средний"),
            (r'\bпесок\b', "Песок мелкий"),
