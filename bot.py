...
ВАЖНО: Обрабатывай ТОЛЬКО ФАКТ (уже выполненные рейсы/действия).
ИГНОРИРУЙ ПЛАНЫ (задания на будущее, "завтра повезёт", "план на день").
Если сообщение — это ПЛАН (не факт), верни ПУСТОЙ массив [].
Признаки факта: "отгрузил", "привёз", "выехал", "доставил", "загрузил", "вернул".
Признаки плана: "план", "завтра", "поедет", "нужно будет", "запланирован".
