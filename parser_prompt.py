...
"Внести изменения в возврат поддонов Горячкина от 29.05, оплата Наличка"
→ [{{"type":"client_edit","client":"Горячкина","date":"29.05.2026","comment":"возврат поддонов 29.05 — оплата наличка"}}]
(возврат поддонов на листе клиента + смена типа оплаты → client_edit, НЕ correction. В comment слова "возврат" и "наличка" — обработчик распознает их и обновит запись возврата + тип оплаты в секции ОПЛАТА.)

"Поправь возврат поддонов ИП Шубина от 19.05 — машина у135рх 193, объект Южный, на нал"
→ [{{"type":"client_edit","client":"ИП Шубина","date":"19.05.2026","comment":"возврат поддонов 19.05, а/м у135рх 193, объект Южный, на нал"}}]
